...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ===== معلومات الرس المتحركة =====
    const facts = [
        { icon: '🏺', text: 'الرس تحتضن مواقع أثرية تعود لآلاف السنين' },
        { icon: '🌴', text: 'تشتهر بزراعة النخيل وإنتاج التمور الجيدة' },
        { icon: '🏰', text: 'تمتلك تراثاً معمارياً طينياً فريداً' },
        { icon: '🎭', text: 'تحافظ على الموروث الشعبي والحرف اليدوية التقليدية' }
    ];

    const ticker = document.createElement('div');
    ticker.style.cssText = `
        background: rgba(176, 120, 80, 0.07);
        border-top: 1px solid rgba(176, 120, 80, 0.15);
        border-bottom: 1px solid rgba(176, 120, 80, 0.15);
        padding: 12px 24px;
        text-align: center;
    `;
