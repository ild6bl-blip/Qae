...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ===== معلومات المذنب المتحركة =====
    const facts = [
        { icon: '🌿', text: 'المذنب تتميز بواحاتها الخضراء الرائعة وسط الصحراء' },
        { icon: '🏘️', text: 'تحتضن قرية تراثية تُعدّ من أجمل القرى التراثية في المملكة' },
        { icon: '🌴', text: 'تُنتج تمور فاخرة متنوعة الأصناف والنكهات' },
        { icon: '🎨', text: 'تشتهر بالحرف اليدوية التقليدية كالنسيج والفخار' }
    ];

    const ticker = document.createElement('div');
    ticker.style.cssText = `
        background: rgba(90, 138, 94, 0.07);
        border-top: 1px solid rgba(90, 138, 94, 0.15);
        border-bottom: 1px solid rgba(90, 138, 94, 0.15);
        padding: 12px 24px;
        text-align: center;
    `;
